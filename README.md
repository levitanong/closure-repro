...
`src/main/closure_repro/client.cljs` contains the code to start and refresh
...
application `closure-repro.development-preload`. You can add code here that
...
```
lein uberjar
java -jar target/closure_repro.jar
```
